...
public class ItemExcavator extends ItemSpade implements IItemToolSM, IAreaBrealToolSM {
    ...
    protected ExcavatorStats stats;
    protected ItemStack craftingStack;

    protected final int height;
    protected final int width;

    public ItemExcavator(ExcavatorStats stats) {
    ...
    private ItemExcavator addToolClass(String str) {
        toolClasses.add(str);
        return this;
    }

    /*
        ItemSpade override methods
    */
