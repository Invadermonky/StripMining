 ...
 *
 * <p>
 * Taken and modified from <a href="https://github.com/WayofTime/BloodMagic/blob/1.12/src/main/java/WayofTime/bloodmagic/util/ChatUtil.java">Blood Magic</a>.
 * </p>
 * <p>
 * <a href="https://github.com/WayofTime/BloodMagic/blob/1.12/LICENSE">Creative Commons Attribution 4.0 International Public License</a>
 * </p>
 */
public class ChatHelper {
    private static final int DELETION_ID = 9583077; //Decimal for "_SM" chars
    ...
    public static void sendChatUnloc(EntityPlayer player, String... unlocLines) {
        sendChat(player, StringHelper.localizeAll(unlocLines));
    }
    ...
    public static void sendNoSpamClientUnloc(String... unlocLines) {
        sendNoSpamClient(StringHelper.localizeAll(unlocLines));
    }
    ...
    public static void sendNoSpamUnloc(EntityPlayer player, String... unlocLines) {
        sendNoSpam(player, StringHelper.localizeAll(unlocLines));
    }
    ...
    public static void sendNoSpam(EntityPlayerMP player, ITextComponent... lines) {
        if (lines.length > 0)
            NetworkHandler.INSTANCE.sendTo(new PacketNoSpamMessage(lines), player);
    }
     ...
     */    public static class PacketNoSpamMessage implements IMessage {
        ...
        private PacketNoSpamMessage(ITextComponent... lines) {
        ...
        public static class Handler implements IMessageHandler<PacketNoSpamMessage,IMessage> {
            @Override
            public IMessage onMessage(PacketNoSpamMessage message, MessageContext ctx) {
